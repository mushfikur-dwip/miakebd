...
return [
    'label'   => [
        ...
        "store_sales_report"         => "স্টোর সেলস রিপোর্ট",
        "branch"                     => "ব্রাঞ্চ",
        "branch_summary"             => "ব্রাঞ্চ সারাংশ",
    ...
    'message' => [
        ...
        'coupon_requires_account'          => 'কুপন ব্যবহার করতে অ্যাকাউন্ট প্রয়োজন। এক ক্লিকেই অ্যাকাউন্ট তৈরি করে কোডটি ব্যবহার করুন।',
