<template>
    ...
    <div class="col-12" v-if="Object.entries(customer).length > 0">
        ...
        <div class="flex flex-col items-start sm:flex-row sm:items-center gap-1.5 mb-6">
            ...
            <button type="button" @click="handleTab($event, '#wallet', '.profile-tabBtn', '.profile-tabDiv', 'active')"
                class="profile-tabBtn w-full justify-start sm:w-fit inline-flex items-center sm:justify-center gap-2 h-[38px] py-2 px-4 rounded-md text-[#6E7191] stroke-[#6E7191]">
                <i class="lab lab-line-wallet"></i>
                <span class="capitalize text-sm">{{ $t("button.wallet") }}</span>
            </button>
        ...
        <div id="wallet" class="profile-tabDiv">
            <CustomerWalletComponent :customerId="parseInt($route.params.id)" />
        </div>
...
import CustomerWalletComponent from "./CustomerWalletComponent.vue";
