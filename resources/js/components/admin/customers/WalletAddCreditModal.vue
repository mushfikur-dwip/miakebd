        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h3 class="text-xl font-bold capitalize">{{ $t('button.add_credit') }}</h3>
            ...
            <form @submit.prevent="submit" class="p-6">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit" :disabled="loading"
                        class="flex-1 py-2.5 px-4 rounded-lg bg-primary text-white font-semibold transition-all duration-300 hover:bg-primary/90 disabled:opacity-50">
                        <span v-if="!loading">{{ $t('button.add_credit') }}</span>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            this.$store.dispatch('customerWallet/addCredit', {
