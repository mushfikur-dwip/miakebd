<template>
    ...
    <SmModalCreateComponent
        v-on:click="this.props.isMap = true"
        :props="addButton"
    />
                    ...
                    <div class="form-row">
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input
                                ...
                                v-bind:class="errors.full_name ? 'invalid' : ''"
                                type="text"
                                id="full_name"
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input
                                ...
                                v-bind:class="errors.zip_code ? 'invalid' : ''"
                                type="text"
                                id="zip_code"
                                class="db-field-control"
                            />
...
export default {
    ...
    methods: {
        ...
        save: function () {
            try {
                const tempId =
                    this.$store.getters["customerAddress/temp"].temp_id;
                this.loading.isActive = true;
                this.$store
