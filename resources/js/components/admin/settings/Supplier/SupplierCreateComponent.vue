                ...
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12">
                            <label for="address" class="db-field-title">{{
                                $t("label.address")
                            }}</label>
                            <textarea
                                v-model="props.form.address"
                                v-bind:class="errors.address ? 'invalid' : ''"
                                id="address"
                                class="db-field-control"
                            ></textarea>
                            <small
...
export default {
    ...
    methods: {
        ...
        callCountry: function () {
            this.$store.dispatch("country/lists", {
        ...
        callStates: function (countryName) {
            ...
            this.$store
                .dispatch("state/statesByCountry", countryName)
                .then((res) => {
        ...
        callCities: function (stateName) {
            ...
            this.$store
                .dispatch("city/citiesByState", stateName)
                .then((res) => {
        ...
        save: function () {
            try {
                ...
                fd.append(
                    "state",
                    this.props.form.state === null ? "" : this.props.form.state
                );
                fd.append(
                    "city",
                    this.props.form.city === null ? "" : this.props.form.city
                );
