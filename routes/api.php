...
Route::prefix('admin')->name('admin.')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('customer')->name('customer.')->group(function () {
        ...
        Route::get('/wallet/{customer}', [CustomerController::class, 'walletBalance']);
        Route::get('/wallet-transactions/{customer}', [CustomerController::class, 'walletTransactions']);
        Route::post('/wallet-credit/{customer}', [CustomerController::class, 'addCredit']);
        Route::post('/wallet-debit/{customer}', [CustomerController::class, 'deductCredit']);
